    ...
    <footer className="bg-[#f2f2f2] pt-16 border-t border-gray-200">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:admin@fibreregister.my" className="text-gray-800 font-bold hover:text-primary big-text">
                    admin@fibreregister.my
                  </a>
                </div>
              </li> 
            </ul>
      ...
      <div className="w-full bg-black py-6 text-center mt-12">
        ...
        <div className="mt-2 text-gray-300 text-sm font-small">
          ...
          |
          <Link href="/terms-conditions" className="hover:text-white mx-2">Terms & Conditions</Link>
        </div>
      </div>
    </footer> 
  );
