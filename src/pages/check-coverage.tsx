              ...
              {step === 2 && (
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="building_name" required value={formData.building_name} onChange={handleChange} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 outline-none text-gray-700" placeholder="Enter your building name" />
                    </div>
                    <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2">Jalan / Kampung </label>
                        <input type="text" name="jalan" value={formData.jalan} onChange={handleChange} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 outline-none text-gray-700" placeholder="Enter your jalan / kampung" />
                    </div>
                    <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2">Taman / Section / Kampung / Bandar </label>
                        <input type="text" name="taman" value={formData.taman} onChange={handleChange} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 outline-none text-gray-700" placeholder="Enter your taman / section / kampung / bandar" />
                    </div>
                </div>
              )}
                ...
                <div className="space-y-5">
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <textarea name="message" rows={4} value={formData.message} onChange={handleChange} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 outline-none resize-y text-gray-700" placeholder="Enter your message to us"></textarea>
                     </div>
                </div>
              )}
